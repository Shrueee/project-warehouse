<ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="/akun-supplier">Supplier</a>
            </div>
        </div>
    </li>
    ...
    <div id="collapseBarang" class="collapse" aria-labelledby="headingBarang"
        ...
        <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="#"><i class="fas fa-sign-in-alt"></i> Barang Masuk</a>
            <a class="collapse-item" href="#"><i class="fas fa-sign-out-alt"></i> Barang Keluar</a>
        </div>
    </div>
</li> --}}
    ...
    <!-- Sidebar Toggler (Sidebar) -->
        <div class="minimize text-center d-none d-md-inline">
